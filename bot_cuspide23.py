...
# Ejecutar con: python3 bot_cuspide23.py desde la terminal
...
ganancia_acumulada = 0.0  # sigue existiendo como neto
...
def revisar_posiciones():
    global capital_libre, ganancia_acumulada, posiciones, ganancia_total, perdida_total
    nuevas_posiciones = []
    for p in posiciones:
        ...
        if actual >= p['take_profit'] or actual <= p['stop_loss']:
            ...
            if ganancia_neta >= 0:
                ...
                perdida_total += abs(ganancia_neta)
    ...
    try:
        ...
        for u in updates:
            ...
            if mensaje.startswith("/start"):
                ...
                estado = f"💹 Estado:\nCapital: ${CAPITAL_TOTAL:.2f}\nLibre: ${capital_libre:.2f}\nGanancias: ${ganancia_total:.2f}\nPérdidas: ${perdida_total:.2f}\nNeto G/P: ${ganancia_acumulada:.2f}\nPosiciones: {len(posiciones)}"
